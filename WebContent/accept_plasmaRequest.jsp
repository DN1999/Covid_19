...
String sql ="select * from plasma_donation where id="+id;
		...
		<div class="row">
			<div
				...
				<h1 class="text-center">
					<u>Accept Plasma Request</u>
				</h1>
				<div class="card-body">
							
					 		
						<form  name="myform" action="Update_PlasmaRequest.jsp" method="POST" onsubmit="return validateform()" >
                           <div class="form-group">
							<input type="hidden" name="id" value="<%=rs.getString("id")%>">
								<label><h5>First Name:</h5></label> <input type="text"
									class="form-control" name="firstName" value="<%=rs.getString("firstName")%>"
							...
							<div class="form-group">
								<label><h5>Date:</h5></label> <input type="text"
									class="form-control" name="rdate" value="<%=rs.getString("rdate")%>"
									placeholder="Enter blood" />
							</div>
							<div class="form-group">
								<label><h5>Blood:</h5></label> <input type="text"
									class="form-control" name="blood" value="<%=rs.getString("blood")%>"
									placeholder="Enter blood" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label><h5>Contact No:</h5></label> <input type="text"
									class="form-control" name="c_no" value="<%=rs.getString("c_no")%>"
                    	...
                    	<option value="PAN Card">PAN Card</option> -->
							...
							<div class="form-group">
								<label><h5>Center Pincode:</h5></label> <input type="text"
									...
									placeholder="Enter Center Pincode" /><span id="numloc"></span>
							</div>
							<div class="form-group">
								<label><h5>Plasma Donate Date:</h5></label> <input type="date"
