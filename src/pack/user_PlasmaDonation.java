...
public class user_PlasmaDonation extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String firstName,lastName ,blood,age,gender,rdate,pincode,city,status,c_no;
		...
		System.out.print(gender);
	        try{  
	            ...
	            PreparedStatement ps=conn.prepareStatement("INSERT INTO plasma_donation(firstName,lastName,blood,age,gender,rdate,pincode,city,status,c_no) VALUES (?,?,?,?,?,?,?,?,?,?)");  
